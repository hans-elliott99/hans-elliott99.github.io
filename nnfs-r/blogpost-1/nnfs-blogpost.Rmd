...
# The Task
This function simulates data in a spiral form with 3 labels, as seen below. This provides us with a basic _multi-class classification_ task, where we want the neural network to learn the decision boundaries that effectively separate each class. This function is inspired by this [Stanford course](https://cs231n.github.io/neural-networks-case-study/).  
```{r sim-data}
